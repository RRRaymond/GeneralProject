...
public class Rank3 : MonoBehaviour {
	...
	void Start () {
		...
		this.GetComponent<Image>().sprite = Resources.Load("liu1", typeof(Sprite)) as Sprite;
	}
...
//		obj1.GetComponent<Image>().sprite = Resources.Load("zong1", typeof(Sprite)) as Sprite;
		...
		obj3.GetComponent<Image>().sprite = Resources.Load("ji1", typeof(Sprite)) as Sprite;

		string[] names = { "陈胖1", "陈钧涛陈胖2", "采芒果的小胖胖", "游小小小小胖", "喵喵胖" };
		int[] scores = { 1024, 512, 256, 128, 64 };

		var request = (HttpWebRequest)WebRequest.Create("http://closecv.com:5000/api/score/game3");
